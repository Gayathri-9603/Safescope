...
class ParentUser(AbstractBaseUser):
    ...
    children = models.JSONField(default=list)  # Store child emails as list
...
class BrowsingLog(models.Model):
    ...
    is_night_time = models.BooleanField()
    ...
    class Meta:
        db_table = "browsing_logs"

    def __str__(self):
        return f"{self.child_email} - {self.label}"
